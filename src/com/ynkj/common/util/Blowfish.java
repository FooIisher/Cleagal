...
public class Blowfish {
	...
	public static String passwordKey = "yDGjIJmMsnVcClJ";
	
	public static void main(String[] args) {
		Blowfish fish = new Blowfish("y6LqNmgjBLB3dUU");
		System.out.println(fish.encryptString("123456"));
	}

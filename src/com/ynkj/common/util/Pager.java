...
public class Pager {
	...
	public String getQuerySQLHeader(){ //Add by SHI CHANGGEN
		return "SELECT /*+ FIRST_ROWS */ * FROM ( SELECT A.*, ROWNUM RN FROM (";
	}
	...
	public String getMysqlQueryCondition() {
		...
		this.pageOffset = (this.pageId - 1) * this.pageSize;
		this.pageTail = pageOffset+pageSize;
		if ((this.pageOffset + this.pageSize) > this.rowCount)
			this.pageTail = this.rowCount;
		
		//condition = "and rownum >" + pageOffset + " and rownum <=" + pageTail;
